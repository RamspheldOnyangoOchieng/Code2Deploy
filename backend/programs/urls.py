...
from .views import (
    ...
    EnrollInProgramView, 
    EnrollInProgramBodyView,
    UserEnrollmentsViewWithFilter, 
    UserProgramStatsView
)
...
urlpatterns = [
    ...
    path('programs/enroll/', EnrollInProgramBodyView.as_view(), name='enroll-in-program-body'),
